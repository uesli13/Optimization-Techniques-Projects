...
xlabel('x');
ylabel('y');
title('Newton''s Method: Comparison of Starting Points');
hold on;
...
for i = 1:size(start_points, 1)
    ...
    [x_hist, y_hist, f_hist, k, fun_calls, grad_calls, hess_calls, x_min, y_min, f_min] = newton_a(x1, y1, gamma, e, @f, @grad_f, @hessian_f);
